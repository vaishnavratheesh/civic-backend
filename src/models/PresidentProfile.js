...
const presidentProfileSchema = new mongoose.Schema({
  ...
  // Term and additional details to fill after login (similar to councillor)
...
module.exports = mongoose.model('PresidentProfile', presidentProfileSchema, 'presidentProfiles');
